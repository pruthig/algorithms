		...
		*(USHORT *)(&addHTInfoTmp.AddHtInfo3) = SWAP16(*(USHORT *)(&addHTInfoTmp.AddHtInfo3));
		...
		FrameLen += TmpLen;
                ...
                {    
                        ...
                        RalinkSpecificProbeIe[1]=pAd->SpecAssocRspIELenth;
                        NdisCopyMemory(&RalinkSpecificProbeIe[2], pAd->SpecAssocRspIE, pAd->SpecAssocRspIELenth);

                        //hex_dump("RalinkSpecificBeaconIe",RalinkSpecificBeaconIe,130);
                        MakeOutgoingFrame(pOutBuffer+FrameLen, &ProbeReqTmpLen,
                                                                pAd->SpecAssocRspIELenth+2, RalinkSpecificProbeIe,
                                                                END_OF_ARGS);
