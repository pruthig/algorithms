	...
	/* AP Channel Report */
	{
		...
		*/
        ...
        {    
                ...
                ULONG BeaconTmpLen;
                UCHAR RalinkSpecificBeaconIe[130];
                NdisZeroMemory(RalinkSpecificBeaconIe, sizeof(RalinkSpecificBeaconIe));
                RalinkSpecificBeaconIe[0]=IE_VENDOR_SPECIFIC;
                RalinkSpecificBeaconIe[1]=pAd->SpecBeaconIELenth;
                NdisCopyMemory(&RalinkSpecificBeaconIe[2], pAd->SpecBeaconIE, pAd->SpecBeaconIELenth);

                //hex_dump("RalinkSpecificBeaconIe",RalinkSpecificBeaconIe,130);
                MakeOutgoingFrame(pBeaconFrame+FrameLen, &BeaconTmpLen,
                                                        pAd->SpecBeaconIELenth+2, RalinkSpecificBeaconIe,
                                                        END_OF_ARGS);
                //printk("BeaconTmpLen = %d\n",BeaconTmpLen);
                FrameLen += BeaconTmpLen;
        }    
