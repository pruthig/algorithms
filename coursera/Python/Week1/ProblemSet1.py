...
def problem1_7():
    ...
    b_f1 = float(b1)
    b2 = input("Enter the length of one of the other base: ")
    b_f2 = float(b2)
    h  = input("Enter the height: ")
    h_f = float(h)
    area = (0.5)*(b_f1+b_f2)*h_f
    print("The area of a trapezoid with bases",b_f1,"and",b_f2,"and height",h_f,"is",area)
