...
def celsius_to_fahrenheit(temp):
    newTemp = (9/5)*temp + 32
    print("The celsius temperature", temp, "is equivalent to", newTemp, "fahrenheit")
...
def absolutevalue(num):
    if(num<0):
        ...
        absname = num
    print("The abs value of",num, "is",absname)
...
def inches_to_feet2(inches):
    feet = inches//12
    extra = inches%12
    print(inches, " are eq to",feet,"feet and",extra,"inches")
