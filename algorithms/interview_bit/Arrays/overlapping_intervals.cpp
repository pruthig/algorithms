// Insert an interval between two intervals
// Cases:
// Corner : 
// Interval before start and after end
// Normal : 
// In-between two interval
// Overlapping - min(newInterval.start, intervals[st].start), max(newInterval.end, intervals[i].end)
